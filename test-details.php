...
<head>
    ...
    <title>Covid Vaccination Portal  | Vaccination  Details</title>
...
endwhile;
  ?>
            ...
            <option value="On the Way for Collection">registration confirmed</option>
            <option value="Sample Collected">slot booked</option>
            <option value="Sent to Lab">availability of vaccine</option>
            <option value="Delivered">slot confirmed</option>
            <?php elseif($reportstatus=='On the Way for Collection'):?>
            <option value="Sample Collected">registration confirmed</option>
            <option value="Sent to Lab">slot booked</option>
            <option value="Delivered">availability of vaccine</option>
